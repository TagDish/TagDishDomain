package com.tagdish.constant;

public interface TagDishDomainConstant {

	public static final String TAGDISH_INDEX_NAME = "tag_dish";
	...
	public static final String VIEW_DISH_DETAIL_NOTIFY_TYPE ="View Dish Detail";	
}
